...
#ifndef ENGINIOIDENTITYAUTHOPERATION_H
#define ENGINIOIDENTITYAUTHOPERATION_H

#include "enginiooperation.h"

class EnginioIdentityAuthOperationPrivate;
class EnginioAbstractObject;

class ENGINIOCLIENT_EXPORT EnginioIdentityAuthOperation : public EnginioOperation
{
    Q_OBJECT
public:
    EnginioIdentityAuthOperation(EnginioClient *client,
                                 QObject *parent = 0);
...
public slots:
    ...
    void attachToSessionWithToken(const QString &sessionToken);
    void logout();
