...
#ifndef ENGINIOQUERYOPERATION_P_H
#define ENGINIOQUERYOPERATION_P_H
...
{
    Q_OBJECT
    Q_DECLARE_PUBLIC(EnginioQueryOperation)

public:
    EnginioQueryOperationPrivate(EnginioQueryOperation *op = 0);
    ~EnginioQueryOperationPrivate();
